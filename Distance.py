# -*- coding: utf-8 -*-
"""
Created on Fri Oct  9 19:54:29 2015
...
# -*- coding: utf-8 -*-
"""
Created on Fri Oct  9 20:12:18 2015
...
#Function to calculate total transportation cost for each site
def cost ():
    j = 0
    d = dict()
    
    #Loop that calculates total transportation cost for each possible plant location
    while j < len(df["long"]):
        plant_lat = df["lat"][j]
